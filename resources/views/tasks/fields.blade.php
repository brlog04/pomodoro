...
<div class="form-group col-sm-6">
    ...
    <input type="text" id="name" name="name"
        @if (isset($tasks->id)) value="{{ old('name', $tasks->name) }}" @endif class="form-control"
        required><br>
</div>
...
<div class="form-group col-sm-6">
    ...
    <input type="text" id="status_id" name="status_id"
        @if (isset($tasks->status_id)) value="{{ old('name', $tasks->status_id) }}" @endif class="form-control"
        required><br>
</div>
...
<div class="form-group col-sm-6">
    ...
    <input type="text" id="user_id" name="user_id"
        @if (isset($tasks->user_id)) value="{{ old('name', $tasks->user_id) }}" @endif class="form-control"
        required><br>
</div>
...
<div class="form-group col-sm-6">
    ...
    <input type="text" id="project_id" name="project_id"
        @if (isset($tasks->project_id)) value="{{ old('name', $tasks->project_id) }}" @endif class="form-control"
        required><br>
</div>
